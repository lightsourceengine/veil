...
# Target libjerry
set(JERRY_LIBS jerry-core jerry-port jerry-ext)
...
elseif("${TARGET_OS}" MATCHES "LINUX|TIZEN|OPENWRT")
  set(JERRY_NATIVE_LIBS m)
  list(APPEND DEPS_LIB_JERRY_ARGS -DJERRY_MATH=OFF)
...
add_cmake_arg(DEPS_LIB_JERRY_ARGS JERRY_PARSER_DUMP_BYTE_CODE)
...
if(NOT "${TARGET_OS}" MATCHES "NUTTX|TIZENRT")
  ...
  add_dependencies(jerry-port libjerry)
  set_property(TARGET jerry-port PROPERTY
      IMPORTED_LOCATION ${CMAKE_BINARY_DIR}/lib/${JERRY_PORT_NAME})

#  build_lib_name(JERRY_PORT_NAME jerry-port)
#  build_lib_name(JERRY_PORT_DEFAULT_NAME jerry-port-default)
#  set_property(DIRECTORY APPEND PROPERTY
#    ADDITIONAL_MAKE_CLEAN_FILES
#      ${CMAKE_BINARY_DIR}/${JERRY_PORT_NAME}
#  )
...
#  add_dependencies(jerry-port libjerry)
#  set_property(TARGET jerry-port PROPERTY
#    IMPORTED_LOCATION ${CMAKE_BINARY_DIR}/${JERRY_PORT_NAME})
#
#  set(JERRY_PORT_DIR ${DEPS_LIB_JERRY_SRC}/jerry-port)
endif()
