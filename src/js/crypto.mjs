...
const { base64Encode, shaEncode, rsaVerify} = import.meta.native
...
Verify.prototype.verify = function(publicKey, signature) {
  if (this.data) {
    ...
    var hash = shaEncode(this.data, type);
    return rsaVerify(type, hash, publicKey, signature);
  }
...
Hash.prototype.digest = function(encoding) {
  ...
  var result;
  var type = shaTypes[this.hashtype];
  result = shaEncode(this.data, type);
