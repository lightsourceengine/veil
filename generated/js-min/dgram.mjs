...
return t.lookup=u,t}throw new Error('Bad socket type specified. Valid types are: udp4')}class a extends e{constructor(e,t){var r
let i
...
return this.emit('error',n),this._bindState=s,void 0}l(this)})),this}sendto(e,t,r,i,n,s){if('number'!==typeof t||'number'!==typeof r)throw new Error('send takes offset and length as args 2 and 3')
...
let u
if(n||i&&'function'!==typeof i)e=p(e,t,r)
else o=i,i=t,n=r
...
else if(!(u=_(e)))throw new TypeError('Buffer list arguments must be buffers or strings')
...
if(h._bindState!==f)return m(h,h.send.bind(h,u,i,n,o)),void 0
h._handle.lookup(n,((e,t)=>w(e,h,t,u,n,i,o)))}close(e){if('function'===typeof e)this.on('close',e)
...
return e}setBroadcast(e){const t=this._handle.configure(g.BROADCAST,e?1:0)
if(t)throw r(t,'setBroadcast')}setTTL(e){if('number'!==typeof e)throw new TypeError('Argument must be a number')
const t=this._handle.configure(g.TTL,e)
...
const t=this._handle.configure(g.MULTICASTTTL,e)
if(t)throw r(t,'setMulticastTTL')
return e}
setMulticastLoopback(e){const t=this._handle.configure(g.MULTICASTLOOPBACK,e?1:0)
...
this._handle.recvStop(),this._receiving=false,this.fd=null}}const c=(e,t)=>new a(e,t)
function l(e){e._handle.onmessage=y,e._handle.recvStart(),e._receiving=true,e._bindState=f,e.fd=-42,e.emit('listening')}function p(e,t,r){if('string'===typeof e)e=new Buffer(e)
else if(!Buffer.isBuffer(e))throw new TypeError('First argument must be a buffer or string')
return t|=0,r|=0,e.slice(t,t+r)}function _(e){const{length:t}=e,r=new Array(t)
for(let i=0,n=t;i<n;i++){const t=e[i]
if('string'===typeof t)r[i]=new Buffer(t)
else if(!Buffer.isBuffer(t))return null
else r[i]=t}return r}function m(e,t){if(!e._queue)e._queue=[],e.once('listening',b)
e._queue.push(t)}function b(){const e=this._queue
this._queue=void 0
for(let t=0;t<e.length;t++)e[t]()}function w(e,r,i,n,s,o,f){if(e){if('function'===typeof f)return f(e),void 0
...
if(u&&f)e=t(u,'send',s,o),process.nextTick(f,e)}var g={BROADCAST:0,TTL:1,MULTICASTTTL:2,MULTICASTLOOPBACK:3}
function y(e,t,i,n){var s=t.owner
if(e<0)return s.emit('error',r(e,'recvmsg'))
n.size=i.length,s.emit('message',i,n)}const T={Socket:a,createSocket:c}
export{a as Socket,c as createSocket,T as default}
