import{createVerify as e}from'crypto'
...
for(var i=e(a.split('-')[1]),o=r.authObject.headers.split(' '),s=0;s<o.length;s++)if(i.update(r.requestObject[o[s]]),s+1!==o.length)i.update('\n')
