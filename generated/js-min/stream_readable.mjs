...
import r from'util'
function n(e){e=e||{},this.buffer=[],this.length=0,this.defaultEncoding=e.defaultEncoding||'utf8',this.flowing=false,this.ended=false,this.endEmitted=false}class s extends e{constructor(e){super(),this._readableState=new n(e)}read(e){var t=this._readableState,i
if(!r.isNumber(e)||e>t.length)e=t.length
else if(e<0)e=0
if(e>0)i=f(this,e)
else i=null
return i}on(e,t){var i=super.on(this,e,t)
...
if(null===e)u(this)
else if(!r.isString(e)&&!Buffer.isBuffer(e))this.error(TypeError('Invalid chunk'))
else if(i.ended)this.error(Error('stream.push() after EOF'))
else{if(r.isString(e))t=t||i.defaultEncoding,e=new Buffer(e,t)
...
r=r||{end:true}
var n={readableListener:a.bind(this),dataListener:d.bind(e),endListener:l.bind(e)}
...
return this.removeListener('readable',i.readableListener),this.removeListener('data',i.dataListener),this.removeListener('end',i.endListener),e}}function a(){this.resume()}function d(e){this.write(e)}function l(){this.end()}function f(e,t){var i=e._readableState,r
if(!t)t=i.length
