...
function n(e){e=e||{},this.buffer=[],this.length=0,this.defaultEncoding=e.defaultEncoding||'utf8',this.flowing=false,this.ended=false,this.endEmitted=false}class Readable extends e{static[r](e,t){e._readableState=new n(t)}constructor(e){super(),Readable[r](this,e)}read(e){var t=this._readableState,i
...
r=r||{end:true}
var n={readableListener:s.bind(this),dataListener:a.bind(e),endListener:d.bind(e)}
...
return this.removeListener('readable',i.readableListener),this.removeListener('data',i.dataListener),this.removeListener('end',i.endListener),e}}function s(){this.resume()}function a(e){this.write(e)}function d(){this.end()}function l(e,t){var i=e._readableState,r
if(!t)t=i.length
if(0===i.buffer.length||0===i.length)r=null
else if(t>=i.length)r=Buffer.concat(i.buffer),i.buffer=[],i.length=0,h(e,r)
else throw new Error('not implemented')
return r}function f(e){var t=e._readableState
if(e.length>0||!t.ended)throw new Error('stream ended on non-EOF stream')
if(!t.endEmitted)t.endEmitted=true,e.emit('end')}function h(e,t){var i=e._readableState
if(0===i.buffer.length||0===i.length)e.emit('data',t)
if(i.ended&&0===i.length)f(e)}function o(e){var t=e._readableState
if(t.ended=true,0===t.length)f(e)}export{Readable,Readable as default}
