...
return P(A(await L(e,r),W))},j=e=>P(A(H(e),H)),A=(e,t)=>{if(g(e)===w)return e
let o,i,{id:n}=e
...
return v.get(t)
case'.json':if(!v.has(t)){const e=JSON.parse(p(t,true))
v.set(t,e)}return v.get(t)
default:throw Error(`CommonJS: unsupported extension '${o}'`)}}
return n.resolve=i,n},O=()=>{const e=new Set(['lexer','internal']),r=Object.freeze(a.filter((r=>!e.has(r)&&!r.startsWith('internal/')))),t={builtinModules:r,createRequire:M},o={default:t,...t},i=s('module.mjs',Object.keys(o)),n='node:module'
i.id=n,m(i,o),y.set(n,i)},P=e=>{if('string'===typeof e)e=y.get(e)
return d(e)},C=e=>{const r=j('internal/napi').default
